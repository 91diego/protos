...
// 	protoc        v4.23.4
// source: products/messages/product.proto

package messages

import (
	models "github.com/91diego/protos/products/models"
...
var file_products_messages_product_proto_rawDesc = []byte{
	0x0a, 0x1f, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x73, 0x2f, 0x6d, 0x65, 0x73, 0x73, 0x61,
...
var (
	file_products_messages_product_proto_rawDescOnce sync.Once
	file_products_messages_product_proto_rawDescData = file_products_messages_product_proto_rawDesc
)

func file_products_messages_product_proto_rawDescGZIP() []byte {
	file_products_messages_product_proto_rawDescOnce.Do(func() {
		file_products_messages_product_proto_rawDescData = protoimpl.X.CompressGZIP(file_products_messages_product_proto_rawDescData)
	})
	return file_products_messages_product_proto_rawDescData
}
...
func init() { file_products_messages_product_proto_init() }
func file_products_messages_product_proto_init() {
	if File_products_messages_product_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_products_messages_product_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_products_messages_product_proto_goTypes,
		DependencyIndexes: file_products_messages_product_proto_depIdxs,
		MessageInfos:      file_products_messages_product_proto_msgTypes,
	}.Build()
	File_products_messages_product_proto = out.File
	file_products_messages_product_proto_rawDesc = nil
	file_products_messages_product_proto_goTypes = nil
	file_products_messages_product_proto_depIdxs = nil
}
